...
- Полный DRF-слой оправдан с мобильным клиентом или публичным API. Для
  production-диагностики сначала достаточно небольших версионированных JSON
  endpoints на Django views: health, состояние push и безопасный self-test.
