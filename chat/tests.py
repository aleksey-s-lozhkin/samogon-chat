...
class ChatLayoutViewsTests(TestCase):
    ...
    def test_chat_has_bartender_actions_only_in_people_panel(self):
        ...
        self.assertLess(content.index('class="online-users user-presence-panel"'), content.index('id="bartender-guest"'))
        self.assertLess(content.index('id="bartender-guest"'), content.index('id="online-users-list"'))
        self.assertContains(response, 'chat/js/date-navigation.js')
